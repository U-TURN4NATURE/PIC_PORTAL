...
// PATCH /api/pic/referrals/:id/email — PIC updates referral email (optional, can be done later)
router.patch('/:id/email', handleUpdateReferralEmail);
